...
- 25 分钟自我回望：不做效率评分。每段结束后只记录“推进了一件事”“维持住了节奏”或“好好休息了”，让工作和恢复都能被善待。
...
- 关闭天空：在“天空与天气”中点“关闭并清除”，会停止天气请求并删除本机保存的城市、坐标与天气缓存。
...
打开“手动修改参数” → “天空与天气”，输入城市并从查询结果中选定一座城市。保存后，组件会每 15 分钟同步一次该城市的天气，并在透明背景上以很轻的云、雨或昼夜提示呈现；金额与黄金价值永远优先。
